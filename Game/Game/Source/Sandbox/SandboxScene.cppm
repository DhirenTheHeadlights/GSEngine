...
export namespace gs {
	...
	auto locomotion_play_scene_setup(
		gse::scene& s
	) -> void;
...
auto gs::locomotion_play_scene_setup(gse::scene& s) -> void {
	s.set_player_factory([next_id = 0u](gse::scene& sc, std::optional<gse::id> server_id) mutable -> gse::id {
		gse::id player_id;
		if (server_id) {
			player_id = gse::find_or_generate_id(server_id->number());
	...
	const auto humanoid = gs::spawn_humanoid(s, gse::vec3<gse::position>(gse::meters(0.f), gse::meters(1.005f), gse::meters(0.f)), gse::quat(1.f, 0.f, 0.f, 0.f));
