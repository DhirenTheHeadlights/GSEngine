 ...
 *
 *  __Do not use this function__ to moveRelativeToOrigin an already visible window unless you
 ...
 *
 *  On some platforms, a window moveRelativeToOrigin, resize or menu operation will cause event
