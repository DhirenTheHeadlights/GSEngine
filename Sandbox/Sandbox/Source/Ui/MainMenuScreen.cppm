...
export namespace sandbox {
	...
	public:
		main_menu_screen(
			...
			gse::channel_write<gse::activate_scene_request, gse::deactivate_active_scene_request, gse::gui::push_screen_request, gse::gui::pop_screen_request, gse::network::connect_request, gse::network::refresh_servers_request, gse::network::send_request, gse::settings::change_request, gse::gui::popout_toggle> channels
		);
	...
	private:
		...
		gse::channel_write<gse::activate_scene_request, gse::deactivate_active_scene_request, gse::gui::push_screen_request, gse::gui::pop_screen_request, gse::network::connect_request, gse::network::refresh_servers_request, gse::network::send_request, gse::settings::change_request, gse::gui::popout_toggle> m_channels;
