...
export struct sphere_mesh_hook final : gse::hook<gse::entity> {
    ...
    auto initialize() -> void override {
        ...
        new_meshes.emplace_back(vertices, indices, gse::model_loader::create_blank_material(std::vector<std::uint32_t> { gse::texture_loader::get_texture_by_path(gse::config::resource_path / "Textures/sun.jpg") }, "Sun"));
