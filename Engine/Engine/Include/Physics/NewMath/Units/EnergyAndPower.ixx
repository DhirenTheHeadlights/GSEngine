export module gse.physics.math.units.eandp;
...
export namespace gse {
	template <typename T = float> using energy_t = internal::quantity<T, units::energy_tag, units::joules, units::energy_units>;
...
export namespace gse {
	template <typename T = float> using power_t = internal::quantity<T, units::power_tag, units::watts, units::power_units>;
