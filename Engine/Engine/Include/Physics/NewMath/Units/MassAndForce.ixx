export module gse.physics.math.units.mass_n_force;
...
export namespace gse {
	template <typename T = float> using mass_t = internal::quantity<T, units::mass_tag, units::kilograms, units::mass_units>;
...
export namespace gse {
	template <typename T = float> using force_t = internal::quantity<T, units::force_tag, units::newtons, units::force_units>;
	...
	template <typename T = float> using torque_t = internal::quantity<T, units::torque_tag, units::newton_meters, units::torque_units>;
