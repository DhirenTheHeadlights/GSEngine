...
gse::mesh::mesh(const std::vector<vertex>& vertices, const std::vector<std::uint32_t>& indices)
	: vertices(vertices), indices(indices) {
}

gse::mesh::mesh(const std::vector<vertex>& vertices, const std::vector<std::uint32_t>& indices, const std::vector<model_texture>& textures)
