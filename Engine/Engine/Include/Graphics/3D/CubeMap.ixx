...
auto gse::cube_map::get_view_matrices(const vec3<length>& position) -> std::vector<mat4> {
    return {
        look_at(position, position + vec3<length>(1.0f, 0.0f,  0.0f), vec3<length>(0.0f, -1.0f, 0.0f)),  // +X
        look_at(position, position + vec3<length>(-1.0f, 0.0f, 0.0f), vec3<length>(0.0f, -1.0f, 0.0f)),  // -X
        look_at(position, position + vec3<length>(0.0f, 1.0f, 0.0f), vec3<length>(0.0f, 0.0f,  1.0f)),   // +Y
        look_at(position, position + vec3<length>(0.0f, -1.0f, 0.0f), vec3<length>(0.0f, 0.0f, -1.0f)),  // -Y
        look_at(position, position + vec3<length>(0.0f, 0.0f, 1.0f), vec3<length>(0.0f, -1.0f, 0.0f)),   // +Z
        look_at(position, position + vec3<length>(0.0f, 0.0f, -1.0f), vec3<length>(0.0f, -1.0f, 0.0f))   // -Z
    };
}
