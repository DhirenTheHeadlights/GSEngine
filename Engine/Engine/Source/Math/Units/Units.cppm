...
export namespace gse {
    ...
    using angle_t = internal::quantity<T, internal::dim<0, 0, 0, 1>, angle_tag, decltype(U)>;
    using angle = angle_t<>;
...
export namespace gse {
    ...
    using length_t = internal::quantity<T, internal::dim<1, 0, 0, 0>, length_tag, decltype(U)>;
...
export namespace gse {
    ...
    using time_t = internal::quantity<T, internal::dim<0, 1, 0, 0>, time_tag, decltype(U)>;
    using time = time_t<>;
...
export namespace gse {
    ...
    using mass_t = internal::quantity<T, internal::dim<0, 0, 1, 0>, mass_tag, decltype(U)>;
    using mass = mass_t<>;
...
export namespace gse {
    ...
    using inverse_mass_t = internal::quantity<T, internal::dim<0, 0, -1, 0>, inverse_mass_tag, decltype(U)>;
...
export namespace gse {
    ...
    using force_t = internal::quantity<T, internal::dim<1, -2, 1, 0>, force_tag, decltype(U)>;
    using force = force_t<>;
...
export namespace gse {
    ...
    using energy_t = internal::quantity<T, internal::dim<2, -2, 1, 0>, energy_tag, decltype(U)>;
...
export namespace gse {
    ...
    using torque_t = internal::quantity<T, internal::dim<2, -2, 1, 0>, torque_tag, decltype(U)>;
...
export namespace gse {
    ...
    using power_t = internal::quantity<T, internal::dim<2, -3, 1, 0>, power_tag, decltype(U)>;
    using power = power_t<>;
...
export namespace gse {
    ...
    using inertia_t = internal::quantity<T, internal::dim<2, 0, 1, 0>, inertia_tag, decltype(U)>;
...
export namespace gse {
    ...
    using velocity_t = internal::quantity<T, internal::dim<1, -1, 0, 0>, velocity_tag, decltype(U)>;
...
export namespace gse {
    ...
    using acceleration_t = internal::quantity<T, internal::dim<1, -2, 0, 0>, acceleration_tag, decltype(U)>;
...
export namespace gse {
    ...
    using angular_velocity_t = internal::quantity<T, internal::dim<0, -1, 0, 1>, angular_velocity_tag, decltype(U)>;
...
export namespace gse {
    ...
    using angular_acceleration_t = internal::quantity<T, internal::dim<0, -2, 0, 1>, angular_acceleration_tag, decltype(U)>;
...
export namespace gse {
    ...
    using density_t = internal::quantity<T, internal::dim<-3, 0, 1, 0>, density_tag, decltype(U)>;
...
export namespace gse {
    ...
    using time_squared_t = internal::quantity<T, internal::dim<0, 2, 0, 0>, time_squared_tag, decltype(U)>;
...
export namespace gse {
    ...
    using stiffness_t = internal::quantity<T, internal::dim<0, -2, 1, 0>, stiffness_tag, decltype(U)>;
...
export namespace gse {
    ...
    using inverse_inertia_t = internal::quantity<T, internal::dim<-2, 0, -1, 0>, inverse_inertia_tag, decltype(U)>;
...
export namespace gse {
    ...
    using area_t = internal::quantity<T, internal::dim<2, 0, 0, 0>, area_tag, decltype(U)>;
    using area = area_t<>;
...
export namespace gse {
    ...
    using angular_stiffness_t = internal::quantity<T, internal::dim<2, -2, 1, -1>, angular_stiffness_tag, decltype(U)>;
