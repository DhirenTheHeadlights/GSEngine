...
namespace gse::internal {
	template <>
	struct dimension_to_tag<dimi<0, 0, 0, 1>> {
		static constexpr bool found = true;
		using tag = gse::angle_tag;
	};

	template <>
	struct quantity_units<gse::angle_tag> {
...
namespace gse::internal {
	template <>
	struct dimension_to_tag<dimi<1, 0, 0, 0>> {
		static constexpr bool found = true;
		using tag = gse::length_tag;
	};
	template <>
	struct dimension_to_tag<dimi<3, 0, 0, 0>> {
		static constexpr bool found = true;
		using tag = gse::volume_tag;
	};
...
namespace gse::internal {
	template <>
	struct dimension_to_tag<dimi<0, 0, 1, 0>> {
		static constexpr bool found = true;
		using tag = gse::mass_tag;
	};
...
namespace gse::internal {
	...
	struct dimension_to_tag<dimi<0, 0, -1, 0>> {
		static constexpr bool found = true;
		using tag = gse::inverse_mass_tag;
	};
}
...
namespace gse::internal {
	template <>
	struct dimension_to_tag<dimi<1, -2, 1, 0>> {
		static constexpr bool found = true;
		using tag = gse::force_tag;
	};

	template <>
	struct quantity_units<gse::force_tag> {
...
namespace gse::internal {
	template <>
	struct dimension_to_tag<dimi<1, -1, 1, 0>> {
		static constexpr bool found = true;
		using tag = gse::impulse_tag;
	};
}
...
export namespace gse {
	struct [[= internal::quantity_root<^^internal::dimi<2, -2, 1, 0>, internal::quantity_semantic_kind::measurement, std::ratio<1>, "N-m">]] torque_tag {};
...
namespace gse::internal {
	template <>
	struct quantity_units<gse::torque_tag> {
		static constexpr auto units = std::tuple{ gse::newton_meters, gse::pound_feet };
	};
}

export namespace gse {
	struct [[= internal::quantity_root<^^internal::dimi<2, -1, 1, 0>, internal::quantity_semantic_kind::measurement, std::ratio<1>, "N-m-s">]] angular_impulse_tag {};
...
namespace gse::internal {
	template <>
	struct dimension_to_tag<dimi<2, -1, 1, 0>> {
		static constexpr bool found = true;
		using tag = gse::angular_impulse_tag;
	};
}
...
namespace gse::internal {
	template <>
	struct dimension_to_tag<dimi<2, -3, 1, 0>> {
		static constexpr bool found = true;
		using tag = gse::power_tag;
	};
...
export namespace gse {
	struct [[= internal::quantity_root<^^internal::dimi<2, 0, 1, 0>, internal::quantity_semantic_kind::measurement, std::ratio<1>, "kg-m^2">]] inertia_tag {};
...
namespace gse::internal {
	template <>
	struct dimension_to_tag<dimi<2, 0, 1, 0>> {
		static constexpr bool found = true;
		using tag = gse::inertia_tag;
	};

	template <>
	struct quantity_units<gse::inertia_tag> {
...
namespace gse::internal {
	template <>
	struct dimension_to_tag<dimi<1, -1, 0, 0>> {
		static constexpr bool found = true;
		using tag = gse::velocity_tag;
	};
...
namespace gse::internal {
	template <>
	struct dimension_to_tag<dimi<1, -2, 0, 0>> {
		static constexpr bool found = true;
		using tag = gse::acceleration_tag;
	};
}
...
namespace gse::internal {
	template <>
	struct dimension_to_tag<dimi<0, -1, 0, 1>> {
		static constexpr bool found = true;
		using tag = gse::angular_velocity_tag;
	};

	template <>
	struct quantity_units<gse::angular_velocity_tag> {
...
namespace gse::internal {
	template <>
	struct dimension_to_tag<dimi<0, -2, 0, 1>> {
		static constexpr bool found = true;
		using tag = gse::angular_acceleration_tag;
	};

	template <>
	struct quantity_units<gse::angular_acceleration_tag> {
...
namespace gse::internal {
	template <>
	struct dimension_to_tag<dimi<-3, 0, 1, 0>> {
		static constexpr bool found = true;
		using tag = gse::density_tag;
	};

	template <>
	struct quantity_units<gse::density_tag> {
...
namespace gse::internal {
	template <>
	struct dimension_to_tag<dimi<0, 2, 0, 0>> {
		static constexpr bool found = true;
		using tag = gse::time_squared_tag;
	};
}
...
namespace gse::internal {
	template <>
	struct dimension_to_tag<dimi<0, -2, 1, 0>> {
		static constexpr bool found = true;
		using tag = gse::stiffness_tag;
	};
}

export namespace gse {
	struct [[= internal::quantity_root<^^internal::dimi<-2, 0, -1, 0>, internal::quantity_semantic_kind::measurement, std::ratio<1>, "1/(kg-m^2)">]] inverse_inertia_tag {};
...
namespace gse::internal {
	...
	struct dimension_to_tag<dimi<-2, 0, -1, 0>> {
		static constexpr bool found = true;
		using tag = gse::inverse_inertia_tag;
	};
}
...
namespace gse::internal {
	template <>
	struct dimension_to_tag<dimi<2, 0, 0, 0>> {
		static constexpr bool found = true;
		using tag = gse::area_tag;
	};

	template <>
	struct quantity_units<gse::area_tag> {
		static constexpr auto units = std::tuple{ gse::square_meters, gse::square_feet };
	};
}

export namespace gse {
	struct [[= internal::quantity_root<^^internal::dimi<2, -2, 1, -1>, internal::quantity_semantic_kind::measurement, std::ratio<1>, "N-m/rad">]] angular_stiffness_tag {};
...
namespace gse::internal {
	template <>
	struct dimension_to_tag<dimi<2, -2, 1, -1>> {
		static constexpr bool found = true;
		using tag = gse::angular_stiffness_tag;
	};
}
...
namespace gse::internal {
	template <>
	struct dimension_to_tag<dimi<1, -2, 1, -1>> {
		static constexpr bool found = true;
		using tag = gse::linear_angular_stiffness_tag;
	};
}
...
namespace gse::internal {
	...
	struct dimension_to_tag<dimi<-1, -2, 1, 0>> {
		static constexpr bool found = true;
		using tag = gse::stiffness_per_length_tag;
	};
}

export namespace gse {
	struct [[= internal::quantity_root<^^internal::dimi<2, -2, 1, -2>, internal::quantity_semantic_kind::measurement, std::ratio<1>, "N-m/rad^2">]] angular_stiffness_per_angle_tag {};
...
namespace gse::internal {
	template <>
	struct dimension_to_tag<dimi<2, -2, 1, -2>> {
		static constexpr bool found = true;
		using tag = gse::angular_stiffness_per_angle_tag;
	};
}
...
export namespace gse {
	...
	template <typename T = float, auto U = ([:internal::resolve_default_unit_info(^^irradiance_tag):])>
	using irradiance_t = internal::quantity_t<irradiance_tag, T, U>;
	using irradiance = irradiance_t<>;
}

namespace gse::internal {
	template <>
	struct dimension_to_tag<dimi<0, -3, 1, 0>> {
		static constexpr bool found = true;
		using tag = gse::irradiance_tag;
	};

	template <>
	struct quantity_units<gse::irradiance_tag> {
		static constexpr auto units = std::tuple{ gse::watts_per_square_meter };
	};
}
...
export namespace gse {
	...
	template <typename T = float, auto U = ([:internal::resolve_default_unit_info(^^inverse_length_tag):])>
	using inverse_length_t = internal::quantity_t<inverse_length_tag, T, U>;
...
namespace gse::internal {
	...
	struct dimension_to_tag<dimi<-1, 0, 0, 0>> {
		static constexpr bool found = true;
		using tag = gse::inverse_length_tag;
	};

	template <>
	struct quantity_units<gse::inverse_length_tag> {
		static constexpr auto units = std::tuple{ gse::per_meter, gse::per_kilometer };
	};
}
