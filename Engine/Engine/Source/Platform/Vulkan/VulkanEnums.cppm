export module gse.platform:vulkan_enums;
...
auto gse::vulkan::to_vk(const gpu::cull_mode mode) -> vk::CullModeFlags {
	switch (mode) {
		case gpu::cull_mode::none:  return vk::CullModeFlagBits::eNone;
		case gpu::cull_mode::front: return vk::CullModeFlagBits::eFront;
		case gpu::cull_mode::back:  return vk::CullModeFlagBits::eBack;
	}
...
auto gse::vulkan::to_vk(const gpu::polygon_mode mode) -> vk::PolygonMode {
	switch (mode) {
		case gpu::polygon_mode::fill:  return vk::PolygonMode::eFill;
		case gpu::polygon_mode::line:  return vk::PolygonMode::eLine;
		case gpu::polygon_mode::point: return vk::PolygonMode::ePoint;
	}
...
auto gse::vulkan::to_vk(const gpu::topology t) -> vk::PrimitiveTopology {
	switch (t) {
		case gpu::topology::triangle_list: return vk::PrimitiveTopology::eTriangleList;
		case gpu::topology::line_list:     return vk::PrimitiveTopology::eLineList;
		case gpu::topology::point_list:    return vk::PrimitiveTopology::ePointList;
	}
...
auto gse::vulkan::to_vk(const gpu::sampler_filter f) -> vk::Filter {
	switch (f) {
		case gpu::sampler_filter::nearest: return vk::Filter::eNearest;
		case gpu::sampler_filter::linear:  return vk::Filter::eLinear;
	}
...
auto gse::vulkan::to_vk(const gpu::sampler_address_mode m) -> vk::SamplerAddressMode {
	switch (m) {
		case gpu::sampler_address_mode::repeat:          return vk::SamplerAddressMode::eRepeat;
		case gpu::sampler_address_mode::clamp_to_edge:   return vk::SamplerAddressMode::eClampToEdge;
		case gpu::sampler_address_mode::clamp_to_border: return vk::SamplerAddressMode::eClampToBorder;
		case gpu::sampler_address_mode::mirrored_repeat: return vk::SamplerAddressMode::eMirroredRepeat;
	}
...
auto gse::vulkan::to_vk(const gpu::border_color c) -> vk::BorderColor {
	switch (c) {
		case gpu::border_color::float_opaque_white:       return vk::BorderColor::eFloatOpaqueWhite;
		case gpu::border_color::float_opaque_black:       return vk::BorderColor::eFloatOpaqueBlack;
		case gpu::border_color::float_transparent_black:  return vk::BorderColor::eFloatTransparentBlack;
	}
...
auto gse::vulkan::to_vk(const gpu::image_format f) -> vk::Format {
	switch (f) {
		case gpu::image_format::d32_sfloat:          return vk::Format::eD32Sfloat;
		case gpu::image_format::r8g8b8a8_srgb:       return vk::Format::eR8G8B8A8Srgb;
		case gpu::image_format::r8g8b8a8_unorm:      return vk::Format::eR8G8B8A8Unorm;
		case gpu::image_format::r8g8b8_srgb:         return vk::Format::eR8G8B8Srgb;
		case gpu::image_format::r8g8b8_unorm:        return vk::Format::eR8G8B8Unorm;
		case gpu::image_format::r8_unorm:            return vk::Format::eR8Unorm;
		case gpu::image_format::b10g11r11_ufloat:    return vk::Format::eB10G11R11UfloatPack32;
		case gpu::image_format::r8g8_snorm:          return vk::Format::eR8G8Snorm;
		case gpu::image_format::r8g8_unorm:          return vk::Format::eR8G8Unorm;
		case gpu::image_format::r16g16b16a16_sfloat: return vk::Format::eR16G16B16A16Sfloat;
	}
...
auto gse::vulkan::to_vk(const gpu::blend_preset preset) -> vk::PipelineColorBlendAttachmentState {
	switch (preset) {
