...
auto gse::layout_compile::log_diagnostics(slang::IBlob* diagnostics) -> void {
...
auto gse::asset_compiler<gse::shader_layout>::source_extensions() -> std::vector<std::string> {
	return { ".slang" };
}

auto gse::asset_compiler<gse::shader_layout>::baked_extension() -> std::string {
	return ".glayout";
}

auto gse::asset_compiler<gse::shader_layout>::source_directory() -> std::string {
	return "Shaders/Layouts";
}

auto gse::asset_compiler<gse::shader_layout>::baked_directory() -> std::string {
	return "Layouts";
}

auto gse::asset_compiler<gse::shader_layout>::compile_one(const std::filesystem::path& source, const std::filesystem::path& destination) -> bool {
...
auto gse::asset_compiler<gse::shader_layout>::needs_recompile(const std::filesystem::path& source, const std::filesystem::path& destination) -> bool {
...
auto gse::asset_compiler<gse::shader_layout>::dependencies(const std::filesystem::path&) -> std::vector<std::filesystem::path> {
