...
export namespace gse::vbd {
	...
	private:
		...
		struct per_frame_data {
			gpu::bindless_buffer body_buffer;
			gpu::bindless_buffer contact_buffer;
			gpu::bindless_buffer motor_buffer;
			gpu::bindless_buffer color_buffer;
			gpu::bindless_buffer contact_offsets_buffer;
			gpu::bindless_buffer contact_counts_buffer;
			gpu::bindless_buffer contact_adjacency_buffer;
			gpu::bindless_buffer motor_map_buffer;
			gpu::bindless_buffer joint_offsets_buffer;
			gpu::bindless_buffer joint_counts_buffer;
			gpu::bindless_buffer joint_adjacency_buffer;
			gpu::bindless_buffer solve_state_buffer;
			gpu::bindless_buffer collision_pair_buffer;
			gpu::bindless_buffer collision_state_buffer;
			gpu::bindless_buffer warm_start_buffer;
			gpu::bindless_buffer joint_buffer;
			gpu::bindless_buffer grid_buffer;
			gpu::buffer physics_snapshot_buffer;
			gpu::bindless_buffer indirect_dispatch_buffer;
			gpu::bindless_buffer frozen_jacobian_buffer;
			gpu::bindless_buffer solve_deltas_buffer;
			gpu::bindless_buffer grounded_buffer;
			gpu::buffer grounded_readback_buffer;
			gpu::bindless_buffer impulse_buffer;
