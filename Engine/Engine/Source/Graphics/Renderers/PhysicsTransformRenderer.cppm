...
export namespace gse::renderer::physics_transform {
	struct system {
		struct data {
			...
			per_frame_resource<vulkan::bindless_buffer> mapping_buffers;
			std::size_t mapping_buffer_size = 0;
			std::uint32_t cached_mapping_count = 0;

			per_frame_resource<vulkan::bindless_buffer_view> body_views;
			per_frame_resource<vulkan::bindless_buffer_view> instance_views;
		};
