...
export namespace gse {
	...
	public:
		struct [[
			...
			= asset_format::built_ins<"Geist-Regular.ttf", "Geist-SemiBold.ttf", "Geist-Italic.ttf", "GeistMono-Regular.ttf", "GeistMono-SemiBold.ttf", "GeistMono-Italic.ttf", "Inter-Regular.ttf", "MonaspaceNeon-Regular.otf">{},
