...
export namespace gse {
	...
	public:
		...
		[[nodiscard]] auto uv() const -> vec4f;

		[[nodiscard]] auto size() const -> vec2f;

		[[nodiscard]] auto bearing() const -> vec2f;

		[[nodiscard]] auto x_advance() const -> float;

		[[nodiscard]] auto shape_size() const -> vec2f;
	...
	public:
		...
		[[nodiscard]] auto glyph_cell_size() const -> float;
