...
export namespace gse::gui {
	...
	concept widget = requires {
		typename W::result;
		requires std::is_same_v<decltype(W::draw(std::declval<draw_context&>(), std::declval<id&>(), std::declval<id&>(), std::declval<id&>())), typename W::result>;
	};
	...
	concept parameterized_widget = requires {
		typename W::params;
		typename W::result;
		requires std::is_same_v<decltype(W::draw(std::declval<draw_context&>(), std::declval<typename W::params>(), std::declval<id&>(), std::declval<id&>(), std::declval<id&>())), typename W::result>;
	};
