...
auto gse::vulkan::pipeline::create_graphics(const device& dev, const graphics_pipeline_create_info& info) -> pipeline {
	...
	const vk::PipelineDepthStencilStateCreateInfo depth_stencil{ .depthTestEnable =
																	 info.depth.test ? vk::True : vk::False,
																 .depthWriteEnable =
																	 info.depth.write ? vk::True : vk::False,
	...
	const vk::PipelineInputAssemblyStateCreateInfo input_assembly{ .topology = to_vk(info.topology),
																   .primitiveRestartEnable = vk::False };

	constexpr std::array dynamic_states = { vk::DynamicState::eViewport, vk::DynamicState::eScissor };

	const vk::PipelineDynamicStateCreateInfo dynamic_state{ .dynamicStateCount =
																static_cast<std::uint32_t>(dynamic_states.size()),
															.pDynamicStates = dynamic_states.data() };

	constexpr vk::PipelineViewportStateCreateInfo viewport_state{ .viewportCount = 1,
																  .pViewports = nullptr,
																  .scissorCount = 1,
																  .pScissors = nullptr };
	...
	const auto blend_attachment = [&]() -> vk::PipelineColorBlendAttachmentState {
		switch (info.blend) {
			case gpu::blend_preset::none:
				return { .blendEnable = vk::False,
						 .colorWriteMask = vk::ColorComponentFlagBits::eR | vk::ColorComponentFlagBits::eG |
							 vk::ColorComponentFlagBits::eB | vk::ColorComponentFlagBits::eA };
			case gpu::blend_preset::alpha:
				return { .blendEnable = vk::True,
	...
	const vk::PipelineColorBlendStateCreateInfo color_blending{ .logicOpEnable = vk::False,
																.logicOp = vk::LogicOp::eCopy,
																.attachmentCount = info.has_color ? 1u : 0u,
																.pAttachments =
																	info.has_color ? &blend_attachment : nullptr };
	...
	vk::raii::Pipeline handle = dev.raii_device().createGraphicsPipeline(
		nullptr,
...
auto gse::vulkan::pipeline::create_compute(const device& dev, const compute_pipeline_create_info& info) -> pipeline {
	...
	vk::raii::Pipeline handle = dev.raii_device().createComputePipeline(
		nullptr,
		{ .flags = vk::PipelineCreateFlagBits::eDescriptorBufferEXT, .stage = vk_stage, .layout = *layout }
	);
