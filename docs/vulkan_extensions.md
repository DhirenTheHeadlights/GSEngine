Vulkan Extensions — Intel(R) Arc(TM) 140V GPU (8GB)
====================================================
...
| Layer | Description | Vulkan Version | Layer Version |
|-------|-------------|----------------|---------------|
| VK_LAYER_KHRONOS_profiles | Khronos Profiles layer | 1.4.341 | 1 |
| VK_LAYER_KHRONOS_shader_object | Khronos Shader object layer | 1.4.341 | 1 |
| VK_LAYER_KHRONOS_synchronization2 | Khronos Synchronization2 layer | 1.4.341 | 1 |
| VK_LAYER_KHRONOS_validation | Khronos Validation Layer | 1.4.341 | 1 |
| VK_LAYER_LUNARG_api_dump | LunarG API dump layer | 1.4.341 | 2 |
| VK_LAYER_LUNARG_crash_diagnostic | Crash/hang debugging tool | 1.4.341 | 1 |
| VK_LAYER_LUNARG_gfxreconstruct | GFXReconstruct Capture Layer | 1.4.341 | 4194309 |
| VK_LAYER_LUNARG_monitor | Execution Monitoring Layer | 1.4.341 | 1 |
| VK_LAYER_LUNARG_screenshot | LunarG image capture layer | 1.4.341 | 1 |
| VK_LAYER_RENDERDOC_Capture | Debugging capture layer for RenderDoc | 1.4.324 | 43 |
| VK_LAYER_VALVE_steam_fossilize | Steam Pipeline Caching Layer | 1.4.303 | 1 |
| VK_LAYER_VALVE_steam_overlay | Steam Overlay Layer | 1.3.207 | 1 |

Device Extensions (161)
-----------------------
